...
public class FuzzlynRng // https://github.com/jakobbotsch/Fuzzlyn/blob/master/Fuzzlyn/Rng.cs
{
    private ulong _s0, _s1, _s2, _s3;

    public FuzzlynRng(ulong s0, ulong s1, ulong s2, ulong s3)
    {
        _s0 = s0;
        _s1 = s1;
        _s2 = s2;
    ...
    public static FuzzlynRng FromSplitMix64Seed(ulong seed)
    {
        ...
        return new FuzzlynRng(NextSplitMix64(), NextSplitMix64(), NextSplitMix64(), NextSplitMix64());
    }
}
